...
>((props, ref) => {
  ...
  return (
    <Progress.Root ref={ref} className={linearProgressVariants().root()} {...rest} />
  );
});
...
const LinearProgressValue = (props: ProgressValueTextProps) => {
  ...
  return (
    <Progress.ValueText
      className={linearProgressVariants().progressValue({
        className,
      })}
      {...rest}
    />
...
export { LinearProgress, LinearProgressLabel, LinearProgressValue, LinearProgressTrack };
