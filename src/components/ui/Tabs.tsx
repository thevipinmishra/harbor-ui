...
const tabVariants = tv({
  slots: {
    ...
    trigger:
      "inline-flex text-sm outline-hidden cursor-pointer items-center font-medium bg-background hover:bg-secondary rounded-t-md gap-2 px-3 motion-safe:transition-colors py-2 text-muted-foreground aria-selected:text-foreground disabled:pointer-events-none disabled:opacity-50",
