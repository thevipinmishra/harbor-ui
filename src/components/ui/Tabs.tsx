...
const tabVariants = tv({
	slots: {
		...
		trigger:
			"inline-flex outline-none items-center font-medium bg-background hover:bg-secondary rounded-t-md text-base gap-2 px-3.5 motion-safe:transition-colors py-2",
...
const TabsTrigger = (props: TabTriggerProps) => {
	const { className, ...rest } = props;
	return (
		<TabsPrimitive.Trigger className={tabVariants().trigger()} {...rest} />
	);
};
